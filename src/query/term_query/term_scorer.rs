...
mod tests {
    ...
    fn test_block_wand() {
        ...
        let bm25_weight = BM25Weight::for_one_term(10, 129, 20f32);
        let mut docs = TermScorer::create_for_test(&doc_tfs[..], &fieldnorms[..], bm25_weight);
        assert_nearly_equals!(docs.block_max_score(), 2.5161593f32);
        docs.shallow_seek(135);
        assert_nearly_equals!(docs.block_max_score(), 3.4597192f32);
        docs.shallow_seek(256);
        assert_nearly_equals!(docs.block_max_score(), 3.9539647f32);
    }
}
